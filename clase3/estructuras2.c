...
strcpy(Coleccion[1].titulo,"Grails is fun");
strcpy(Coleccion[1].autor,"Peir lebroch");
...
strcpy(Coleccion[2].titulo,"Thinking in c");
strcpy(Coleccion[2].autor,"Valdor");
...
printf("Cua es el nombre del autor %d ?\n",i);
