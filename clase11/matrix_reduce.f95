program mult_matrix
    ...
    do i=1,elementos
     suma_parcial=arre(i) + suma_parcial
    end do
    !print *,"proceso",proceso,"resultado",arre

    print *,"Proceso",proceso,"sum_parcial",suma_parcial

    call MPI_REDUCE(suma_parcial,suma_total,1,MPI_INTEGER,MPI_SUM,MASTER,MPI_COMM_WORLD,ierr)
